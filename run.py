...
class Gui(password_strength_checker):
        ...
        def calculation_filed(self):
                ...
                Label(self.root,text='Digits',font=('arial',20),borderwidth = 4,width = 10, relief="ridge",fg ='white',bg ='#34495E').place(relx=0.05,rely=0.3,relheight=0.075)
                Label(self.root,text='Upppercase',font=('arial',20),borderwidth = 4,width = 10, relief="ridge",fg ='white',bg ='#34495E').place(relx=0.3,rely=0.3,relheight=0.075)
                Label(self.root,text='Lowercase',font=('arial',20),borderwidth = 4,width = 10, relief="ridge",fg ='white',bg ='#34495E').place(relx=0.55,rely=0.3,relheight=0.075)
                Label(self.root,text='Special',borderwidth = 4,width = 10, relief="ridge",font=('arial',20),fg ='white',bg ='#34495E').place(relx=0.8,rely=0.3,relheight=0.075)
                ...
                Label(self.root,textvariable= self.digits,font=('arial',20),borderwidth = 4,width = 10, relief="ridge",fg ='white',bg ='#34495E').place(relx=0.05,rely=0.38,relheight=0.075)
                Label(self.root,textvariable= self.upppercase,font=('arial',20),borderwidth = 4,width = 10, relief="ridge",fg ='white',bg ='#34495E').place(relx=0.3,rely=0.38,relheight=0.075)
                ...
                Label(self.root,borderwidth = 4,width = 10, relief="ridge",text=" Online Attack Scenario: Assuming one thousand guesses per second",font=('arial',14,'bold'),wraplength=500,fg ='white',bg ='#34495E').place(rely=0.5,relheight=0.1, relwidth=0.5)
                Label(self.root,borderwidth = 4,width = 10, relief="ridge",text=" Offline Fast Attack Scenario :Assuming one hundred billion guesses per second",font=('arial',14,'bold'),wraplength=500,fg ='white',bg ='#34495E').place(rely=0.67,relheight=0.1, relwidth=0.5)
                Label(self.root,borderwidth = 4,width = 10, relief="ridge",text=" Massive Cracking Array Scenario :Assuming one hundred trillion guesses per second",font=('arial',14,'bold'),wraplength=500,fg ='white',bg ='#34495E').place(rely=0.85,relheight=0.1, relwidth=0.5)
                ...
                Label(self.root,borderwidth = 4,width = 10, relief="ridge",textvariable=self.online,font=('arial',14),wraplength=300,fg ='white',bg ='#34495E').place(relx=0.55,rely=0.459,relheight=0.17,relwidth=0.45)
                Label(self.root,borderwidth = 4,width = 10, relief="ridge",textvariable=self.offline,font=('arial',14),wraplength=300,fg ='white',bg ='#34495E').place(relx=0.55,rely=0.64,relheight=0.17,relwidth=0.45)
                Label(self.root,borderwidth = 4,width = 10, relief="ridge",textvariable=self.massive,font=('arial',14),wraplength=300,fg ='white',bg ='#34495E').place(relx=0.55,rely=0.82,relheight=0.17,relwidth=0.45)
